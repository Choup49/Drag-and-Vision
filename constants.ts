...
export const TRANSLATIONS = {
  en: {
    ...
    correctorTitle: 'Code Doctor',
    correctorDesc: 'Fix Python bugs or transpile your pipeline to high-performance C++.',
    pasteCode: 'Paste Python Code...',
    analyzeBtn: 'Analyze & Fix',
    analyzing: 'Analyzing...',
    fixedCode: 'Refactored Code',
    explanation: 'Analysis & Changes',
    cppExport: 'C++ Export',
  ...
  fr: {
    ...
    correctorTitle: 'Code Doctor',
    correctorDesc: 'Corrigez les bugs Python ou compilez votre pipeline en C++ haute performance.',
    pasteCode: 'Collez le code Python...',
    analyzeBtn: 'Analyser et Corriger',
    analyzing: 'Analyse en cours...',
    fixedCode: 'Code Refactorisé',
    explanation: 'Analyse & Changements',
    cppExport: 'Export C++',
